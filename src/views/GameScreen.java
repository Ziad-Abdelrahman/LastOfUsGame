...
public class GameScreen extends BorderPane{
	...
	Hero selectedHero = Game.heroes.get(0);
		...
		for(int i = 0;i<15;i++) {
			for(int j = 0;j<15;j++) {
				if(!Game.map[i][j].isVisible()) {
					...
					case "Joel Miller":hero=joel;break;
					case "Ellie Williams": hero=ellie; break;
					case "Tess":hero=tess;break;
					case "Riley Abel":hero=riley;break;
					case "Tommy Miller": hero=tommy;break;
					case "Bill": hero=bill;break;
					case "David": hero=david;break;
					case "Henry Burell":hero=henry;break;
					}
	...
	public ImageView choosePortrait(String x) {
		ImageView tmp = null;
		switch(x) {
		case "Joel Miller":tmp=SelectHero.createImage("joel.png");break;
		case "Ellie Williams": tmp=SelectHero.createImage("ellie.png"); break;
		case "Tess":tmp=SelectHero.createImage("tess.png");break;
		case "Riley Abel":tmp=SelectHero.createImage("riley.png");break;
		case "Tommy Miller": tmp=SelectHero.createImage("tommy.png");break;
		case "Bill": tmp=SelectHero.createImage("bill.png");break;
		case "David": tmp=SelectHero.createImage("david.png");break;
		case "Henry Burell":tmp=SelectHero.createImage("henry.png");break;
		default:tmp=SelectHero.zombie;break;
		}
		return tmp;
	}
